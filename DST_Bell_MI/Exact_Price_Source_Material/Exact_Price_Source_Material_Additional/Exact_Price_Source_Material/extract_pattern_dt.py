#!/usr/bin/env python3
"""
TIMESTEP-ROBUSTNESS VARIANT (extract_pattern_dt): DT env exposes the
Euler step (default 0.004). The paper quotes DT=0.004 -> 1.375 and
DT=0.002 -> 1.345 (first-order extrapolation ~1.32).
